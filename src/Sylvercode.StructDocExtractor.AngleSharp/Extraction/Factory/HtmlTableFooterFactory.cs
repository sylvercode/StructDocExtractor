...
/// <summary>
/// Factory that converts AngleSharp <c>&lt;tfoot&gt;</c> elements to <see cref="HtmlTableFooter"/> nodes.
/// </summary>
/// <remarks>
/// The default selector requires a parent matching <see cref="HtmlTableFactory.Selector"/>,
/// so only <c>&lt;tfoot&gt;</c> elements nested directly inside a table are processed.
/// </remarks>
public class HtmlTableFooterFactory : BaseAngleNodeFactory
{
    /// <summary>Gets the shared selector criteria targeting <c>&lt;tfoot&gt;</c> inside a table.</summary>
